...
<html lang="es">
  ...
  <body style="background-color:black; overflow: hidden;">
    ...
    <div class="container">
      <div class="row h-50" style="padding:5%;display:inherit;">
        <div class="d-table-cell align-middle" style="background-color:rgba(0,0,0,0.7);">
          ...
          <button type="button" class="btn btn-outline-warning mx-auto d-block" style="margin:20px">Play for Free</button>
        </div>
      </div>
    </div>
    <!-- Background -->
